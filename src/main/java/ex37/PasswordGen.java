...
public class PasswordGen {
    ...
    public static String PasswordGen(int length, int special, int nums)
    {
    ...
    public static void main(String[] args)
    {
        ...
        int specialChar = Integer.parseInt(in.nextLine());

        System.out.print("How many numbers? ");
        int numbers = Integer.parseInt(in.nextLine());

        System.out.println("Your password is " + PasswordGen(size, specialChar, numbers));
    }
}